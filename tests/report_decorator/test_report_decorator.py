...
def colored_report():
    return (
        "\033[32mData de fabricação mais antiga:" +
        "\033[0m \033[36m2020-09-06\033[0m\n"
        "\033[32mData de validade mais próxima:" +
        "\033[0m \033[36m2023-09-17\033[0m\n"
        "\033[32mEmpresa com mais produtos:" +
        "\033[0m \033[31mTarget Corporation\033[0m"
    )


def test_decorar_relatorio(colored_report):
    report = ColoredReport(SimpleReport)

    assert report.generate(data) == colored_report
